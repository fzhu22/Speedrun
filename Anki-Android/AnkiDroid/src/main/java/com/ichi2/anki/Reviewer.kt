...
open class Reviewer :
    ...
    override fun onCollectionLoaded(col: Collection) {
        ...
        launchCatchingTask { SpeedrunReview.ensureNotetypes() }
    ...
    override suspend fun answerCardInner(rating: Rating) {
        ...
        // Speedrun: update fading and (only when the backend decides the learner is struggling,
        // i.e. typically AGAIN/HARD) prompt for a disconfirmer. Defensive: never breaks review.
        SpeedrunReview.onCardAnswered(this, cardId, rating)
    }
