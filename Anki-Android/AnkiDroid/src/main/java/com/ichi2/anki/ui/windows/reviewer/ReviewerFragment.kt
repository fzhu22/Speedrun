...
class ReviewerFragment :
    ...
    override fun onViewCreated(
        ...
        // Speedrun: review-time parity with the legacy Reviewer. The ViewModel has no Activity,
        // so it hands the answered card here, where the shared hook can show the disconfirmer dialog.
        viewModel.speedrunAnsweredFlow.collectIn(lifecycleScope) { answered ->
            SpeedrunReview.onCardAnswered(requireActivity(), answered.cardId, answered.rating)
        }
